...
layui.use('form', function () {
    ...
    form.on('submit(user_register)', function (data) {
        ...
        layer.open({
            title: '注册确认',
            content: '您的注册信息如下：<br>' + '用户名：' + data.field['name'] + '<br>' + '绑定QQ：' + data.field['qq'] + '<br>' + '绑定手机：' + data.field['mobile'] + '<br>' + '登陆账号：' + data.field['username'] + '<br>' + '登陆密码：' + data.field['password'] + '<br>' + '请确认信息,若有勿,点取消,重新填写！',
            btn: ['注册', '取消'],
            icon: 3,
            btn1: function (layero, index) {
