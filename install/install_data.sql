...
(
    ...
    `originalprice` decimal(24, 8) DEFAULT '-1' COMMENT '原始订单付款金额，未使用优惠券则=-1',
...
(
    ...
    `price`    decimal(24, 8) DEFAULT '-1' COMMENT '原始订单付款金额，未使用优惠券则=-1',
    `coupon`   varchar(255)   DEFAULT '-1' COMMENT '折扣券id',
    `ip`       varchar(255)   DEFAULT NULL,
...
(
    ...
    `name`          varchar(255)   DEFAULT NULL,
    `pricehike`     text NULL COMMENT '商品涨价百分比规则',
...
(
    ...
    `money`    decimal(24, 8) DEFAULT '-1' COMMENT '原始订单付款金额，未使用优惠券则=-1',
    `coupon`   varchar(255)   DEFAULT '-1' COMMENT '折扣券id',
...
VALUES ('2',
        '2',
        '铜牌代理',
        '铜牌代理，可以加盟分店了,其他用户在你分站下单你可以获得提成!',
        '28',
        '2800',
        '10.00',
        '2020-03-18 00:00:00');
...
VALUES ('3',
        '3',
        '银牌代理',
        '银牌代理，除了可以加盟分店外，还可以赚取下级提成，并且收益比上一级别更高！，推荐购买!',
        '26',
        '2600',
        '20.00',
        '2020-03-18 00:00:00');
...
VALUES ('4',
        '4',
        '金牌代理',
        '金牌代理，除了可以加盟分店外，还可以赚取下级提成，并且收益比上一级别更高！，推荐购买!',
        '24',
        '2400',
        '30.00',
        '2020-03-18 00:00:00');
...
VALUES ('5',
        '5',
        '小站长',
        '小站长，除了可以加盟分店外，还可以赚取下级提成，并且收益比上一级别更高！，推荐购买!',
        '22',
        '2200',
        '40.00',
        '2020-03-18 00:00:00');
...
VALUES ('6',
        '6',
        '平台站长',
        '平台站长，除了可以加盟分店外，还可以赚取下级提成，并且收益比上一级别更高！，推荐购买!',
        '20',
        '2000',
        '50.00',
        '2020-03-18 00:00:00');
...
VALUES ('7',
        '7',
        '高级站长',
        '高级站长，除了可以加盟分店外，还可以赚取下级提成，并且收益比上一级别更高！，推荐购买!',
        '18',
        '1800',
        '60.00',
        '2020-03-18 00:00:00');
...
VALUES ('8',
        '8',
        '领袖站长',
        '领袖站长，除了可以加盟分店外，还可以赚取下级提成，并且收益比上一级别更高！，推荐购买!',
        '16',
        '1600',
        '70.00',
        '2020-03-18 00:00:00');
...
(
    ...
    `sizespace`      decimal(65, 2) DEFAULT '200' COMMENT '可用空间大小(MB)',
    `currentsize`    decimal(65, 2) DEFAULT '0' COMMENT '当前空间大小(MB)',
...
(
    ...
    `HostSpace`      decimal(65, 2) DEFAULT '200' COMMENT '主机空间大小配额',
