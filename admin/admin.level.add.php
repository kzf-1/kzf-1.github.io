        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-horizontal layui-form">
                    ...
                    <div class="form-group mb-3">
                        <label for="example-input-normal" style="font-weight: 500">分成阈值(%)</label>
                    ...
                    <div class="form-group mb-3">
                        <label for="example-input-normal" style="font-weight: 500">等级公告</label>
