...
switch ($_QET['act']) {
    ...
    case 'ip': //获取IP
        dier([
            'code' => 1,
            'msg' => 'IP获取成功',
            'ip' => ($_QET['type'] == 1 ? userip() : $_SERVER['SERVER_ADDR'])
        ]);
        break;
    case 'TokenList': //卡密列表
    ...
    case 'UserLevelReset': //等级重置
        ...
        if ($re) {
            $DB->query("INSERT INTO `sky_price` (`mid`,`sort`, `name`, `content`, `priceis`, `pointsis`, `money`, `addtime`,`ActualProfit`,`ProfitThreshold`)  VALUES ('1','1','普通用户', '普通用户，和游客没什么区别!', '30', '3000', '0.00','$date','50','20');");
            $DB->query("INSERT INTO `sky_price` (`mid`,`sort`, `name`, `content`, `priceis`, `pointsis`, `money`, `addtime`,`ActualProfit`,`ProfitThreshold`)  VALUES ('2','2','铜牌代理', '铜牌代理，可以加盟分店了,其他用户在你加盟分店下单你可以获得提成!', '28', '2800', '10.00','$date','50','20');");
            $DB->query("INSERT INTO `sky_price` (`mid`,`sort`, `name`, `content`, `priceis`, `pointsis`, `money`, `addtime`,`ActualProfit`,`ProfitThreshold`)  VALUES ('3','3','银牌代理', '银牌代理，除了可以加盟分店外，还可以赚取下级提成，并且收益比上一级别更高！，推荐购买!', '26', '2600', '20.00','$date','50','20');");
            $DB->query("INSERT INTO `sky_price` (`mid`,`sort`, `name`, `content`, `priceis`, `pointsis`, `money`, `addtime`,`ActualProfit`,`ProfitThreshold`)  VALUES ('4','4','金牌代理', '金牌代理，除了可以加盟分店外，还可以赚取下级提成，并且收益比上一级别更高！，推荐购买!', '24', '2400', '30.00','$date','50','20');");
            $DB->query("INSERT INTO `sky_price` (`mid`,`sort`, `name`, `content`, `priceis`, `pointsis`, `money`, `addtime`,`ActualProfit`,`ProfitThreshold`)  VALUES ('5','5','小站长', '小站长，除了可以加盟分店外，还可以赚取下级提成，并且收益比上一级别更高！，推荐购买!', '22', '2200', '40.00','$date','50','20');");
            $DB->query("INSERT INTO `sky_price` (`mid`,`sort`, `name`, `content`, `priceis`, `pointsis`, `money`, `addtime`,`ActualProfit`,`ProfitThreshold`)  VALUES ('6','6','平台站长', '平台站长，除了可以加盟分店外，还可以赚取下级提成，并且收益比上一级别更高！，推荐购买!', '20', '2000', '50.00','$date','50','20');");
            $DB->query("INSERT INTO `sky_price` (`mid`,`sort`, `name`, `content`, `priceis`, `pointsis`, `money`, `addtime`,`ActualProfit`,`ProfitThreshold`)  VALUES ('7','7','高级站长', '高级站长，除了可以加盟分店外，还可以赚取下级提成，并且收益比上一级别更高！，推荐购买!', '18', '1800', '60.00','$date','50','20');");
            $DB->query("INSERT INTO `sky_price` (`mid`,`sort`, `name`, `content`, `priceis`, `pointsis`, `money`, `addtime`,`ActualProfit`,`ProfitThreshold`)  VALUES ('8','8','领袖站长', '领袖站长，除了可以加盟分店外，还可以赚取下级提成，并且收益比上一级别更高！，推荐购买!', '16', '1600', '70.00','$date','50','20');");
            dies(1, '重置成功！');
        }
        dies(-1, '重置失败！');
        break;
