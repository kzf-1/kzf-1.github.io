                    ...
                    <form class="form-horizontal layui-form">
                        <div class="form-group mb-3">
                            ...
                            <select class="custom-select mt-3" lay-search name="SMSChannelConfiguration">
                                <option <?= $conf['SMSChannelConfiguration'] == 1 ? 'selected' : '' ?> value="1">官方内置
                                </option>
                        ...
                        <div style="margin-top: 1em;text-align: center">
                            <a href="https://ram.console.aliyun.com/manage/ak" target="_blank ">https://ram.console.aliyun.com/manage/ak【阿里云】</a>取得您的AK信息
                        </div>
                    </form>
                </div>
