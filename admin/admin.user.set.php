        ...
        <div class="card">
            ...
            <div class="layui-form card-body mdui-p-a-0">
                ...
                <div id="Se4" class="mdui-p-a-2">
                    ...
                    <div class="form-group mb-3">
                        <label for="example-input-normal">用户签到赠送积分数量</label>
                        <input type="text" name="Signin" lay-verify="required" class="form-control"
                               value="<?= $conf['Signin'] ?>" placeholder="每天签到奖励的<?= $conf['currency'] ?>数量">
                    </div>
                    <div class="form-group mb-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <fieldset class="layui-elem-field">
                    ...
                    <div class="layui-field-box">
                        1、用户在分店内购买商品，分店店长可获得<font color="red">差价</font>提成（同级别，或无差价，无法获得提成奖励）<br>
