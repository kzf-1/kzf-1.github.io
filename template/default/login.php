            ...
            <?php if ($conf['AccountPasswordLogin'] == 1 && empty($_QET['mode'])) {
                if ($_QET['register'] <> 1) {
                    ...
                    <div class="layui-row">
                        ...
                        <div class="layui-col-xs5">
                            <div style="margin-left: 10px;">
                                <img id="vc" src="/user/ajax.php?act=VerificationCode&n=Login_vc"
                                     onclick="this.src='/user/ajax.php?act=VerificationCode&n=Login_vc';"
                    ...
                    <div class="layui-form-item">
                        ...
                        <input type="number" name="qq" lay-verify="required" placeholder="请输入绑定QQ，用于头像显示"
                               class="layui-input">
                    </div>

                    <div class="layui-form-item">
                        <label class="layadmin-user-login-icon layui-icon layui-icon-user"></label>
                        <input type="text" name="name" lay-verify="required" placeholder="请输入用户名，取一个好听的名字"
                               class="layui-input">
                    </div>

                    <div class="layui-form-item">
                        <label class="layadmin-user-login-icon layui-icon layui-icon-cellphone"></label>
                        <input type="text" name="mobile" lay-verify="required" placeholder="请输入绑定手机，用于快捷登陆"
                               class="layui-input">
                    </div>
                    ...
                    <div class="layui-form-item">
                        <label class="layadmin-user-login-icon layui-icon layui-icon-about"></label>
                        <input type="password" name="password2" lay-verify="required" placeholder="请重复输入登陆密码"
                               class="layui-input">
                    </div>
                    ...
                    <div class="layui-row">
                        ...
                        <div class="layui-col-xs5">
                            <div style="margin-left: 10px;">
                                <img id="vc" src="/user/ajax.php?act=VerificationCode&n=Login_res"
                                     onclick="this.src='/user/ajax.php?act=VerificationCode&n=Login_res';"
                                     class="layadmin-user-login-codeimg">
                            </div>
                        </div>
                    </div>
                ...
                if ($conf['sms_switch_user'] == 1) { ?>
                    ...
                    <div class="layui-trans layui-form-item layadmin-user-login-other">
                        ...
                        <?php if ($conf['AccountPasswordLogin'] == 1) { ?>
                            <a href="./" class="layui-icon layui-icon-survey LoginIcon" title="账号密码登陆"></a>
                        <?php } ?>
                    </div>
                <?php } else { ?>
...
<script src="./assets/admin/js/login_user.js?t=<?= $accredit['versions'] ?>"></script>
<script>
