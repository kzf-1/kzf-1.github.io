...
class kakayun
{
    ...
    public static function CommodityStatus($Goods, $Supply)
    {
        ...
        if ((int)$CurlDataJson['code'] === -1 || (int)$CurlDataJson['goodsdetails']['goodsstatus'] === 0) {
            return [
                'code' => 1,
                'msg' => '数据获取成功',
                'data' => [
        ...
        return [
            ...
            'data' => [
                ...
                'state' => 1,
                'money' => (float)$CurlDataJson['price']['data']['goodsprice'],
                'specification' => false,
            ]
        ];
    }
    ...
    public static function ProductDetails($Data)
    {
        ...
        return [
            'code' => 1,
            'msg' => '对接参数自动填写成功！<br>商品进货成本：1' . $Goods['unit'] . ' ' . $CurlDataJson['price']['data']['goodsprice'] . '元',
            'data' => [
