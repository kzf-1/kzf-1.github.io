...
class yile
{
    ...
    public static function GoodsList($Data)
    {
        ...
        $CurlData = Api::Curl('http://' . $SourceData['url'] . '.api.yilesup.net/api/goods/list', $Post);
    ...
    public static function CommodityStatus($Goods, $Supply)
    {
        ...
        $CurlData = Api::Curl('http://' . $Supply['url'] . '.api.yilesup.net/api/goods/info', $Post);
    ...
    public static function ProductDetails($Data)
    {
        ...
        $CurlData = Api::Curl('http://' . $SourceData['url'] . '.api.yilesup.net/api/goods/info', $Post);
        ...
        if ($CurlDataJson['status'] === 0) {
            ...
            if (strpos($Goods['image'], 'http') === false) {
                if (!empty($Goods['image'])) {
                    ...
                    $Goods['image'] = 'http://' . $SourceData['url'] . '/' . $Goods['image'];
                }
    ...
    public static function Submit($OrderData, $Goods, $TypeSupply)
    {
        ...
        $DataCurl = Api::SuppluCurl('http://' . $TypeSupply['url'] . '.api.yilesup.net/api/order', $DataPost);
    ...
    public static function Query($id, $TypeSupply)
    {
        ...
        $TypeSupply['url'] = StringCargo::UrlVerify($TypeSupply['url'], 2);
        $DataCurl = Api::Curl('http://' . $TypeSupply['url'] . '.api.yilesup.net/api/order/query', $DataPost);
