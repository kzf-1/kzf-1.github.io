...
$Signin = $DB->get('config', ['V'], ['k' => 'Signin'])['V'];
?>
<div class="row">
            ...
            <div class="card-body">
                <form class="form-horizontal layui-form">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="ServiceTips" lay-verify="required"
                               class="form-control"
                    ...
                    <div class="form-group mb-3">
                        <label for="example-input-normal" style="font-weight: 500">签到赠送(最高可设置为:<font
                                    color="#1e90ff"><?= $Signin ?></font>)</label>
                        <input type="text" name="Signin" lay-verify="required"
                               class="form-control"
                               value="<?= ($data_arr['Signin'] == '' ? $conf['Signin'] : $data_arr['Signin']) ?>"
                               placeholder="每天签到奖励的<?= ($data_arr['currency'] == '' ? $conf['currency'] : $data_arr['currency']) ?>数量">
                    </div>
